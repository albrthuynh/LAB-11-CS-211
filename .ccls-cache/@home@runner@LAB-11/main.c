...
void ahuyn2_wsehw2_omarin6(){
    printf("\nAlbert Huynh, Omar Marin, Waseem Sehwail\n");
    printf("gitHub comprises of git and that we have to manipulate\n" "the repository in order to pull the repository in order to make\n" "changes\n");
}
int main() {
  printf(
